      ...
      <div className="section-container section-padding">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Sua parceira em{' '}
            <span className="gradient-text">Infraestrutura Operacional</span>
          </h2>
          <p className="text-lg text-gray-500">
            Nós não entregamos um login e sumimos. A IOY constrói a profissionalização do seu negócio junto com você.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-100 p-8 md:p-12 text-center card-shadow">
          ...
          <p className="text-xl md:text-2xl text-gray-700 leading-relaxed mb-6">
            "Eu vi de perto o preço que a desorganização cobra. A IOY não nasceu para criar mais um aplicativo. Ela nasceu porque as empresas merecem infraestrutura para crescer. Quando você organiza a casa, o crescimento deixa de ser uma aposta e passa a ser uma consequência lógica."
          </p>
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-left">
              <p className="font-bold text-gray-900 text-sm">Fundador</p>
